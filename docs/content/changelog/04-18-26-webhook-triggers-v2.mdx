...
Project-scoped endpoints give each project:

- A dedicated ingress rate-limit and backpressure budget
- Clean fan-out — events reach only that project's trigger instances
- A signing secret and app-level token scoped to this project alone
