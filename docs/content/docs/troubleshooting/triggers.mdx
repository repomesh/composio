...
## Webhook endpoint issues (your-own OAuth on Slack, Notion, etc.)

These only apply when you've configured the webhook endpoint yourself — see [Configuring the webhook endpoint](/docs/setting-up-triggers/creating-triggers#configuring-the-webhook-endpoint). With Composio-managed OAuth apps, the endpoint is provisioned automatically and these issues don't apply.
