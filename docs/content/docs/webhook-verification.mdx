...
<Callout>
**Two signatures, two responsibilities.** Composio verifies provider signatures on the **ingress** hop automatically. You verify Composio's signature on the **delivery** hop — this page covers that.
</Callout>
